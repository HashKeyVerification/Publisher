 ...
 * @author	Brett Miller
 * @version	0.0.1
 * @originalAuthor Kaidong Wu (wukd94@pku.edu.cn)
 */
...
contract DataContract {
    ...
    string private Publisher;
	uint32 private Major;
    uint32 private Minor;
    uint32 private Build;
    uint32 private Revision;
    string private Hash;
